...
var scTooltipMgr = {
	...
	fNavie:null, fNavie8:null, fNavn6:null,
	...
	xGetEltW: function(pElt) {
		return(this.xInt(pElt.offsetWidth)+(this.fNavie? (this.xInt(pElt.currentStyle.borderRightWidth)+this.xInt(pElt.currentStyle.borderLeftWidth)):0));
	},
	xGetEltH: function(pElt) {
		return(this.xInt(pElt.offsetHeight)+(this.fNavie? (this.xInt(pElt.currentStyle.borderTopWidth)+this.xInt(pElt.currentStyle.borderBottomWidth)):0));
	},
	xGetEltL: function(pElt) {
		var vX = this.xInt(pElt.offsetLeft);
	...
	xGetEltT: function(pElt) {
		var vY = this.xInt(pElt.offsetTop);
		if (pElt.offsetParent && pElt.offsetParent.tagName.toLowerCase() != 'body' && pElt.offsetParent.tagName.toLowerCase() != 'html') {
